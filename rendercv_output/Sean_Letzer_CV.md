...
# Experience
## **Fisica**, Senior Software Engineer
...
- Maintained and optimized the core embedded software codebase for a **Battery Management System (BMS)**.

- Achieved 100% MC/DC coverage using **Parasoft**, advancing the BMS codebase towards **DO-178C DAL-A** (SW-CI 1) compliance.

- Designed and deployed DevOps infrastructure using **Docker Compose** and Infrastructure-as-Code (IaC) best practices, self-hosting **GitLab**, **Parasoft DTP**, **Nginx** (reverse proxy), and Go-links.
...
**Static Analysis & Code Review:** Codebear Collaborator, Klockwork, Coverity, Parasoft

**Security:** SELINUX, TLS, Linux PAM Module

**Toolchains:** GCC, Crosstool-ng, Buildroot, Yocto
